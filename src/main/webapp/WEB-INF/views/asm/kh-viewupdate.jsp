...
<div class="container border border-primary rounded-4" style="width: 500px">
    ...
    <form action="/asm/kh-update" method="post" class="py-4">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="ten" name="ten" value="${kh.ten}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="trangThai" value="true" ${kh.trangThai?"checked":""}>
                <label class="form-check-label">
                    Đang hoạt động
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="trangThai" value="false" ${!kh.trangThai?"checked":""}>
                <label class="form-check-label">
                    Dừng hoạt động
                </label>
            </div>
