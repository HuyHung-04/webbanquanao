        ...
        <c:forEach items="${danhSach}" var="spct">
            <tr>
                ...
                <td class="d-flex justify-content-evenly">
                    <a class="btn btn-primary" href="/asm/spct-detail?id=${spct.id}">Chi tiết</a>
                    <a class="btn btn-danger" href="/asm/spct-delete?id=${spct.id}">Xoá</a>
                    <a class="btn btn-warning" href="/asm/spct-viewupdate/${spct.id}">Sửa</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
    <a class="btn btn-primary" href="/asm/spct-viewadd">Thêm sản phẩm chi tiết</a>
