...
<div class="container border border-primary rounded-4" style="width: 500px">
    <h3>Sửa hoá đơn</h3>
    <form action="/hoadonchitiet/hdct-update" method="post" class="py-4">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="idSPCT" name="idSPCT" value="${hdct.idSPCT}">
        </div>
        <div class="mb-3">
            <label for="idHoaDon" class="form-label">ID hoá đơn</label>
            <input type="text" class="form-control" id="idHoaDon" name="idHoaDon" value="${hdct.idHoaDon}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="trangThai" value="true" ${hdct.trangThai? "checked":""}>
                <label class="form-check-label">
                    Chưa thanh toán
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="trangThai" value="false" ${!hdct.trangThai? "checked":""}>
                <label class="form-check-label">
                    Đã thanh toán
                </label>
            </div>
